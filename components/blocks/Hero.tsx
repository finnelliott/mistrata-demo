        ...
        <Container>
            ...
            <div className="flex flex-col items-start justify-center text-left w-full col-span-1">
                <div className="space-y-4 flex flex-col place-items-start w-full">
                    <h1 className="font-medium font-display text-gray-900 text-3xl sm:text-5xl text-left max-w-4xl leading-snug sm:leading-tight dark:text-gray-50">{block.heading}</h1>
                    <p className="font-normal text-lg text-gray-600 text-left max-w-2xl dark:text-gray-400">{block.subheading}</p>
                </div>
